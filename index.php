...
<body>
    ...
    <div id="main">
        <h2 class="lista" onclick="wys('aktualne', 'z1')"><span id="z1">></span><span> Aktualna tabela kursów</span></h2>
        <div id="aktualne">
            <?php
        ...
        <hr>
        <h2 class="lista" onclick="wys('archiwum', 'z2')"><span id="z2">></span><span> Archiwalne tabele kursów</span></h2>
        <div id="archiwum">
        ...
        <hr>
        <h2 class="lista" onclick="wys('calc','z3')"><span id="z3">></span><span> Kalkulator walutowy</span></h2>
        <div id="calc">
            ...
            <hr>
            <h2 class="lista" onclick="wys('wykresy','z4')"><span id="z4">></span><span> Wybrane wykresy</span></h2>
            <div id="wykresy">
                <h3><a href="wykres_eur.php">Wykres kusu Euro</a></h3>
                <h3><a href="wykres_gbp.php">Wykres kusu Funta Brytyjskiego</a></h3>
